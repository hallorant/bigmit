...
; ---------------
; Load bytes from memory rather than DOS file reads.
;BUFF3	EQU	0D800H	;MASTER BOARD
	ORG	$d800
BUFF3:	INCBIN	master_board.inc ; MASTER BOARD
;CLRS	EQU	9000H	;COLORS FOR BOARD
	ORG	$9000
CLRS:	INCBIN	board_colors.inc ; COLORS FOR BOARD
; ---------------
	ORG	7000H
...
ENTRY	DI
	LD	SP,CHARS
	JP	CASSTART ; TO CASSETTE START (NO FILE READ)
	LD	DE,DCB
	LD	B,0
	LD	HL,DSKBUF
	CALL	4424H ; @OPEN
